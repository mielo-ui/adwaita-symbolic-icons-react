...
const UserTrash = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
  ...
  >
    <g fill="">
      ...
      <path d="M7 7v5c0 .277-.223.5-.5.5S6 12.277 6 12V7c0-.277.223-.5.5-.5s.5.223.5.5M10 7v5c0 .277-.223.5-.5.5S9 12.277 9 12V7c0-.277.223-.5.5-.5s.5.223.5.5m0 0" />
    </g>
  </svg>
)
const ForwardRef = forwardRef(UserTrash)
